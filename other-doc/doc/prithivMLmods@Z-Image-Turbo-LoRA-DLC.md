...
# Bash API documentation for prithivMLmods/Z-Image-Turbo-LoRA-DLC
API Endpoints: 5
...
```bash
curl -X POST https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/update_selection -s -H "Content-Type: application/json" -d '{
	"data": [
							1024,
	...
	| awk -F'"' '{ print $4}'  \
	| read EVENT_ID; curl -N https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/update_selection/$EVENT_ID
```
...
```bash
curl -X POST https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/add_custom_lora -s -H "Content-Type: application/json" -d '{
	"data": [
							"Hello!!"
						
	]}' \
	| awk -F'"' '{ print $4}'  \
	| read EVENT_ID; curl -N https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/add_custom_lora/$EVENT_ID
```
...
```bash
curl -X POST https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/remove_custom_lora -s -H "Content-Type: application/json" -d '{
	"data": [
	]}' \
	| awk -F'"' '{ print $4}'  \
	| read EVENT_ID; curl -N https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/remove_custom_lora/$EVENT_ID
```
...
```bash
curl -X POST https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/run_lora -s -H "Content-Type: application/json" -d '{
	"data": [
							"Hello!!",
	...
	| awk -F'"' '{ print $4}'  \
	| read EVENT_ID; curl -N https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/run_lora/$EVENT_ID
```
...
```bash
curl -X POST https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/get_random_value -s -H "Content-Type: application/json" -d '{
	"data": [
	]}' \
	| awk -F'"' '{ print $4}'  \
	| read EVENT_ID; curl -N https://prithivmlmods-z-image-turbo-lora-dlc.hf.space/gradio_api/call/get_random_value/$EVENT_ID
```
