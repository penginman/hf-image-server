...
export const translations = {
  en: {
    ...
    channelStrategyAuto: "Auto Select (Recommended)",
    channelStrategyManual: "Manual Selection",
    channelAutoSelected: "Auto-selected channel",
    channelStatusTitle: "Channel Status",
    channelStatusAvailable: "可用",
    channelStatusLimited: "限流中",
    channelStatusUnavailable: "不可用",
    channelOptionPublic: "Public Resource (Free)",
    channelOptionHfToken: "Use My Hugging Face API Key",
    channelOptionPublicShort: "公共资源",
    channelOptionHfTokenShort: "Hugging Face Key",
    channelTokenLabel: "Access Token",
    channelTokenHint: "Hugging Face API Token",
    channelTokenPlaceholder: "hf_xxxxxxxx...",
  ...
  zh: {
    ...
    channelStrategyAuto: "自动择优（推荐）",
    channelStrategyManual: "手动指定",
    channelAutoSelected: "自动选择渠道",
    channelStatusTitle: "渠道状态",
    channelStatusAvailable: "可用",
    channelStatusLimited: "限流中",
    channelStatusUnavailable: "不可用",
    channelOptionPublic: "公共资源（免费）",
    channelOptionHfToken: "使用我的 Hugging Face API Key",
    channelOptionPublicShort: "公共资源",
    channelOptionHfTokenShort: "Hugging Face Key",
    channelTokenLabel: "访问令牌",
    channelTokenHint: "Hugging Face API 令牌",
    channelTokenPlaceholder: "hf_xxxxxxxx...",
    autoTranslate: "自动翻译",
    translating: "翻译中...",
    live: "Live 图",
